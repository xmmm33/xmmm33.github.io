...
//	 var searchtype = $("input[name='searchtype']".val());
 ...
 //xmlHttp = 获得xmlHttp对象; 
	...
	//alert(xmlHttp);  filename
	 //3.要给服务器发送数据,首先定义一个服务器的地址， 
	 var url = "fileIndex?filename="+content+"&index="+index+"&root="+root+"&vague="+vague+"&type="+type;
	 //var url = "fileIndex?openfile="+openfile;
 ...
 function setContent(contents){ 
  ...
  //设置内容 
	 for(var i =0;i < size;i++){ 
		 ...
		 //var jstr = JSON.stringify(nextNode);
		 //td.attachEvent("onclick",openFile(jstr));
